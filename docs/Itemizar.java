...
public class Itemizar {
	...
	Long codigoOrcamento;
	ItemizarOrcamentoUtil itemizador;

	public Itemizar(Long codigoOrcamento, ItemizarOrcamentoUtil itemizador) {
	 ...
	 * */
	public HashMap<Long, String> doITM(Long codigoOrcamento, IAcoesConv acoesConv) throws Exception {

		HashMap<Long, String> map = new HashMap<Long, String>();
		String itoc1_itm_etapa = "";

		if (!itemizador.itemizacaoAutomatica)
			return map;
		...
		str.append(" TS1_ITOC ");
		str.append("WHERE");
		str.append(" ITOC1_COD_PAI = ").append(codigoOrcamento);
	 ...
	 * @param mascara
	 *            Máscara da itemização - a máscara aqui deve estar formatada de acordo com o tipo(ITOC1_TIP) 
	 *            do item que se quer obter a itemização.
