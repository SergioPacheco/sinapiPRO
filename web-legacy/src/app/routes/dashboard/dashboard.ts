...
import { KpiCardComponent, KpiConfig } from '@shared';
...
interface Kpi {
  ...
  progress?: number; footer?: string; route?: string; queryParams?: Record<string, string>;
}
...
@Component({
  ...
  imports: [MatButtonModule, MatIconModule, RouterLink, KpiCardComponent],
})
