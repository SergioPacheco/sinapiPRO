...
export const routes: Routes = [
  { path: 'login', loadComponent: () => import('./pages/login/login.component').then(m => m.LoginComponent) },
  {
    ...
    children: [
      ...
      // Cross-project (global views)
      { path: 'budgets', loadComponent: () => import('./pages/budget-worksheet/budget-global.component').then(m => m.BudgetGlobalComponent) },
      { path: 'budgets/:budgetId', loadComponent: () => import('./pages/budget-worksheet/budget-worksheet.component').then(m => m.BudgetWorksheetComponent) },
      { path: 'finance', loadComponent: () => import('./pages/finance/finance-global.component').then(m => m.FinanceGlobalComponent) },
      { path: 'service-orders', loadComponent: () => import('./pages/service-orders/service-orders.component').then(m => m.ServiceOrdersComponent) },
      ...
      { path: 'registry', loadComponent: () => import('./pages/registry/registry.component').then(m => m.RegistryComponent),
        children: [
          ...
          { path: 'transporters', loadComponent: () => import('./pages/registry/generic-list.component').then(m => m.GenericListComponent), data: { entity: 'transporters', title: 'Transportadores' } },
          { path: 'sales-reps', loadComponent: () => import('./pages/registry/generic-list.component').then(m => m.GenericListComponent), data: { entity: 'sales-representatives', title: 'Representantes Comerciais' } },
          { path: 'contractors', loadComponent: () => import('./pages/registry/generic-list.component').then(m => m.GenericListComponent), data: { entity: 'contractors', title: 'Empreiteiros' } },
          { path: 'config', loadComponent: () => import('./pages/registry/config-tables.component').then(m => m.ConfigTablesComponent) },
        ],
      },
