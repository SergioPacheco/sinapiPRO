...
export const routes: Routes = [
  { path: 'login', loadComponent: () => import('./pages/login/login.component').then(m => m.LoginComponent) },
  {
    ...
    children: [
      ...
      // Acesso direto (cross-project) — como no Strato
      { path: 'budgets', loadComponent: () => import('./pages/budget-worksheet/budget-global.component').then(m => m.BudgetGlobalComponent) },
      { path: 'budgets/:budgetId', loadComponent: () => import('./pages/budget-worksheet/budget-worksheet.component').then(m => m.BudgetWorksheetComponent) },
      { path: 'contracts', loadComponent: () => import('./pages/projects/projects.component').then(m => m.ProjectsComponent) },
      { path: 'measurements', loadComponent: () => import('./pages/projects/projects.component').then(m => m.ProjectsComponent) },
      { path: 'procurement', loadComponent: () => import('./pages/projects/projects.component').then(m => m.ProjectsComponent) },
      { path: 'finance', loadComponent: () => import('./pages/projects/projects.component').then(m => m.ProjectsComponent) },
      { path: 'daily-logs', loadComponent: () => import('./pages/projects/projects.component').then(m => m.ProjectsComponent) },
