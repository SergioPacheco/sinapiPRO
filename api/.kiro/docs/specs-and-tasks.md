...
|---------------------|--------------|------------|
| Job Costing (custo por código/fase) | ❌ Não existe | P0 |
| Cronograma / Planejamento Físico | ❌ Não existe | P0 |
| Medições de Obra (avanço físico) | ❌ Não existe | P0 |
| Composições SINAPI (insumos + coeficientes) | ❌ Não existe na API | P1 |
| Contratos e Aditivos | ❌ Não existe | P1 |
| Suprimentos (cotação → pedido → recebimento) | ❌ Não existe | P1 |
| Orçamento detalhado (etapas → itens → composições) | ⚠️ Parcial (budget é simplificado) | P1 |
| Relatórios (Curva ABC, Curva S, Cronograma Financeiro) | ❌ Não existe | P2 |
| Diário de Obra | ❌ Não existe | P2 |
| Dashboard com indicadores | ❌ Não existe | P2 |
| Gestão de Equipamentos | ❌ Não existe | P3 |
| BDI (Benefícios e Despesas Indiretas) | ❌ Não existe | P3 |
