...
import br.edu.ifrn.sinapiPRO.service.CadastroClienteReferenciaService;
import br.edu.ifrn.sinapiPRO.service.exception.*;
@Controller
@RequestMapping("/clientesReferencia")
public class ClientesReferenciaController {
	@Autowired
	private CadastroClienteReferenciaService service;
	
	@GetMapping("/novo/{codigoCliente}")
	public ModelAndView novo(@PathVariable Long codigoCliente, ClienteReferencia r) {
