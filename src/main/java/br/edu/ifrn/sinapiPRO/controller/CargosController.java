...
import br.edu.ifrn.sinapiPRO.controller.page.PageWrapper; import br.edu.ifrn.sinapiPRO.model.Cargo;
import br.edu.ifrn.sinapiPRO.repository.filter.CargoFilter; import br.edu.ifrn.sinapiPRO.service.CadastroCargoService;
import br.edu.ifrn.sinapiPRO.service.exception.*;
@Controller @RequestMapping("/cargos")
public class CargosController {
	@Autowired private CadastroCargoService service;
	@GetMapping("/novo") public ModelAndView novo(Cargo e) { return new ModelAndView("cargo/CadastroCargo"); }
	@PostMapping({"/novo","{\\d+}"}) public ModelAndView cadastrar(@Valid Cargo e, BindingResult r, RedirectAttributes a) {
	...
	@GetMapping public ModelAndView pesquisar(CargoFilter f, BindingResult r, @PageableDefault(size=25) Pageable p, HttpServletRequest req) {
