...
import br.edu.ifrn.sinapiPRO.controller.page.PageWrapper; import br.edu.ifrn.sinapiPRO.model.Funcao;
import br.edu.ifrn.sinapiPRO.repository.filter.FuncaoFilter; import br.edu.ifrn.sinapiPRO.service.CadastroFuncaoService;
import br.edu.ifrn.sinapiPRO.service.exception.*;
@Controller @RequestMapping("/funcoes")
public class FuncoesController {
	@Autowired private CadastroFuncaoService service;
	@GetMapping("/novo") public ModelAndView novo(Funcao e) { return new ModelAndView("funcao/CadastroFuncao"); }
	@PostMapping({"/novo","{\\d+}"}) public ModelAndView cadastrar(@Valid Funcao e, BindingResult r, RedirectAttributes a) {
	...
	@GetMapping public ModelAndView pesquisar(FuncaoFilter f, BindingResult r, @PageableDefault(size=25) Pageable p, HttpServletRequest req) {
