...
public class TiposObraController {
	@Autowired
	private CadastroTipoObraService service;
	
	@GetMapping("/novo")
	public ModelAndView novo(TipoObra t) {
		return new ModelAndView("tipoobra/CadastroTipoObra");
	}
	...
	@GetMapping
	public ModelAndView pesquisar(TipoObraFilter f, BindingResult r, @PageableDefault(size=25) Pageable p, HttpServletRequest req) {
