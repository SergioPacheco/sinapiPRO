...
public class MovimentosBancariosController {
	@Autowired
	private MovimentoBancarioService service;
	@Autowired
	private ContaBancariaService contaService;
	@Autowired
	private HistoricoBancarioService historicoService;
	@GetMapping
	...
	@GetMapping("/novo")
	public ModelAndView novo(MovimentoBancario m) {
		return form(m);
	}

	
	@PostMapping("/novo")
	public ModelAndView salvar(@Valid MovimentoBancario m, BindingResult r, RedirectAttributes a) {
