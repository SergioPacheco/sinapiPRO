...
import br.edu.ifrn.sinapiPRO.model.DiarioClima; import br.edu.ifrn.sinapiPRO.service.CadastroDiarioClimaService;
import br.edu.ifrn.sinapiPRO.service.exception.*;
@Controller @RequestMapping("/diarioClimas")
public class DiarioClimasController {
	@Autowired private CadastroDiarioClimaService service;
	@GetMapping("/novo") public ModelAndView novo(DiarioClima e) { return new ModelAndView("diarioclima/CadastroDiarioClima"); }
	@PostMapping({"/novo","{\\d+}"}) public ModelAndView cadastrar(@Valid DiarioClima e, BindingResult r, RedirectAttributes a) {
