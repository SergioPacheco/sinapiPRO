...
import br.edu.ifrn.sinapiPRO.controller.page.PageWrapper; import br.edu.ifrn.sinapiPRO.model.Empresa;
import br.edu.ifrn.sinapiPRO.repository.filter.EmpresaFilter; import br.edu.ifrn.sinapiPRO.service.CadastroEmpresaService;
import br.edu.ifrn.sinapiPRO.service.exception.*;
@Controller @RequestMapping("/empresas")
public class EmpresasController {
	@Autowired private CadastroEmpresaService service;
	@GetMapping("/novo") public ModelAndView novo(Empresa e) { return new ModelAndView("empresa/CadastroEmpresa"); }
	@PostMapping({"/novo","{\\d+}"}) public ModelAndView cadastrar(@Valid Empresa e, BindingResult r, RedirectAttributes a) {
	...
	@GetMapping public ModelAndView pesquisar(EmpresaFilter f, BindingResult r, @PageableDefault(size=25) Pageable p, HttpServletRequest req) {
