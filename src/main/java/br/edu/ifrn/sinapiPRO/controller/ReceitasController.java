...
public class ReceitasController {
	...
	@GetMapping("/novo")
	public ModelAndView novo(Receita r) {
		return form(r);
	}
	...
	public ModelAndView editar(@PathVariable Long codigo) {
		return form(service.buscarComRecebimentos(codigo));
	}

	
	@PostMapping({"/novo","/{codigo}"})
	public ModelAndView salvar(@Valid Receita r, BindingResult br, RedirectAttributes a) {
