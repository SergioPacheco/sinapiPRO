...
public ModelAndView lista() {
	ModelAndView mv = new ModelAndView("notafiscalservico/ListaNotasFiscais");
	mv.addObject("notas", service.findAll());
	return mv;
}

@GetMapping("/novo") public ModelAndView novo(NotaFiscalServico nf) {
	return form(nf);
}
