...
import br.edu.ifrn.sinapiPRO.model.Equipamento; import br.edu.ifrn.sinapiPRO.service.CadastroEquipamentoService;
import br.edu.ifrn.sinapiPRO.service.exception.*;
@Controller @RequestMapping("/equipamentos")
public class EquipamentosController {
	@Autowired private CadastroEquipamentoService service;
	@GetMapping("/novo") public ModelAndView novo(Equipamento e) { return new ModelAndView("equipamento/CadastroEquipamento"); }
	@PostMapping({"/novo","{\\d+}"}) public ModelAndView cadastrar(@Valid Equipamento e, BindingResult r, RedirectAttributes a) {
	...
	@GetMapping public ModelAndView listar() { ModelAndView mv = new ModelAndView("equipamento/ListaEquipamentos"); mv.addObject("equipamentos", service.findAll()); return mv; }
