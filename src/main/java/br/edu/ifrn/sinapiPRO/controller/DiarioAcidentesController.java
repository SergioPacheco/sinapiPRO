...
import br.edu.ifrn.sinapiPRO.model.DiarioAcidente; import br.edu.ifrn.sinapiPRO.service.CadastroDiarioAcidenteService;
import br.edu.ifrn.sinapiPRO.service.exception.*;
@Controller @RequestMapping("/diarioAcidentes")
public class DiarioAcidentesController {
	@Autowired private CadastroDiarioAcidenteService service;
	@GetMapping("/novo") public ModelAndView novo(DiarioAcidente e) { return new ModelAndView("diaroacidente/CadastroDiarioAcidente"); }
	@PostMapping({"/novo","{\\d+}"}) public ModelAndView cadastrar(@Valid DiarioAcidente e, BindingResult r, RedirectAttributes a) {
