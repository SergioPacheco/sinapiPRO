...
import br.edu.ifrn.sinapiPRO.controller.page.PageWrapper; import br.edu.ifrn.sinapiPRO.model.SubDivisaoInsumo;
import br.edu.ifrn.sinapiPRO.repository.filter.SubDivisaoInsumoFilter;
import br.edu.ifrn.sinapiPRO.service.CadastroSubDivisaoInsumoService; import br.edu.ifrn.sinapiPRO.service.CadastroDivisaoInsumoService;
import br.edu.ifrn.sinapiPRO.service.exception.*;
@Controller @RequestMapping("/subDivisoesInsumo")
public class SubDivisoesInsumoController {
	@Autowired private CadastroSubDivisaoInsumoService service;
	@Autowired private CadastroDivisaoInsumoService divisaoService;
	@GetMapping("/novo") public ModelAndView novo(SubDivisaoInsumo s) {
	...
	@PostMapping({"/novo","{\\d+}"}) public ModelAndView cadastrar(@Valid SubDivisaoInsumo s, BindingResult r, RedirectAttributes a) {
	...
	@GetMapping public ModelAndView pesquisar(SubDivisaoInsumoFilter f, BindingResult r, @PageableDefault(size=25) Pageable p, HttpServletRequest req) {
