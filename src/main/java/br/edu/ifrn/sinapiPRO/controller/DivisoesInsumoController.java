...
public class DivisoesInsumoController {
	@Autowired
	private CadastroDivisaoInsumoService service;
	
	@GetMapping("/novo")
	public ModelAndView novo(DivisaoInsumo d) {
		return new ModelAndView("divisaoinsumo/CadastroDivisaoInsumo");
	}
	...
	@GetMapping
	public ModelAndView pesquisar(DivisaoInsumoFilter f, BindingResult r, @PageableDefault(size=25) Pageable p, HttpServletRequest req) {
