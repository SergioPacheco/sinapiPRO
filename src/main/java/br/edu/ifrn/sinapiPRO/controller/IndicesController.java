...
public class IndicesController {
	@Autowired
	private CadastroIndiceService service;
	
	@GetMapping("/novo")
	public ModelAndView novo(Indice i) {
		return new ModelAndView("indice/CadastroIndice");
	}
	...
	@GetMapping
	public ModelAndView pesquisar(IndiceFilter f, BindingResult r, @PageableDefault(size=25) Pageable p, HttpServletRequest req) {
