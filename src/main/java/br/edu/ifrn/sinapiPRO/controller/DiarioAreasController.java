...
public class DiarioAreasController {
	@Autowired
	private CadastroDiarioAreaService service;
	
	@GetMapping("/novo")
	public ModelAndView novo(DiarioArea e) {
		return new ModelAndView("diarioarea/CadastroDiarioArea");
	}

	
	@PostMapping({"/novo", "/{codigo}"})
	public ModelAndView cadastrar(@Valid DiarioArea e, BindingResult r, RedirectAttributes a) {
