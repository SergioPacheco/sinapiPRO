...
import br.edu.ifrn.sinapiPRO.model.DiarioArea; import br.edu.ifrn.sinapiPRO.service.CadastroDiarioAreaService;
import br.edu.ifrn.sinapiPRO.service.exception.*;
@Controller @RequestMapping("/diarioAreas")
public class DiarioAreasController {
	@Autowired private CadastroDiarioAreaService service;
	@GetMapping("/novo") public ModelAndView novo(DiarioArea e) { return new ModelAndView("diarioarea/CadastroDiarioArea"); }
	@PostMapping({"/novo","{\\d+}"}) public ModelAndView cadastrar(@Valid DiarioArea e, BindingResult r, RedirectAttributes a) {
		...
		a.addFlashAttribute("mensagem", "DiarioArea salvo(a)!"); return new ModelAndView("redirect:/diarioAreas/novo"); }
	@GetMapping public ModelAndView listar() {
		ModelAndView mv = new ModelAndView("diarioarea/PesquisaDiarioAreas");
