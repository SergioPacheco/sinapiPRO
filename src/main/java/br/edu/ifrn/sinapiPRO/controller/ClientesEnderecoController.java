...
import br.edu.ifrn.sinapiPRO.model.ClienteEndereco; import br.edu.ifrn.sinapiPRO.model.Cliente;
import br.edu.ifrn.sinapiPRO.service.CadastroClienteEnderecoService; import br.edu.ifrn.sinapiPRO.service.exception.*;
@Controller @RequestMapping("/clientesEndereco")
public class ClientesEnderecoController {
	@Autowired private CadastroClienteEnderecoService service;
	@GetMapping("/novo/{codigoCliente}") public ModelAndView novo(@PathVariable Long codigoCliente, ClienteEndereco e) {
	...
	@PostMapping({"/novo/{codigoCliente}","{\\d+}"}) public ModelAndView cadastrar(@PathVariable Long codigoCliente, @Valid ClienteEndereco e, BindingResult r, RedirectAttributes a) {
