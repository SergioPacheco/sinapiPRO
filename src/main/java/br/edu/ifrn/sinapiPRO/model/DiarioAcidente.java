...
@Entity @Table(name = "diario_acidente")
public class DiarioAcidente implements Serializable {
	...
	@Override public boolean equals(Object o) { if (!(o instanceof DiarioAcidente)) return false; return codigo != null && codigo.equals(((DiarioAcidente)o).codigo); }
}
