...
public class SubDivisaoInsumo implements Serializable {
	...
	public DivisaoInsumo getDivisao() { return divisao; } public void setDivisao(DivisaoInsumo d) { this.divisao = d; }
	public boolean isNovo() { return codigo == null; }
	@Override public int hashCode() { return codigo == null ? 0 : codigo.hashCode(); }
	@Override public boolean equals(Object o) { if (!(o instanceof SubDivisaoInsumo)) return false; SubDivisaoInsumo x = (SubDivisaoInsumo) o; return codigo != null && codigo.equals(x.codigo); }
}
