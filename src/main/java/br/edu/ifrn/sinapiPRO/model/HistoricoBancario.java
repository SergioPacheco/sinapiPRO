...
@Entity @Table(name = "historico_bancario")
public class HistoricoBancario implements Serializable {
	...
	@Override public boolean equals(Object o) { if (!(o instanceof HistoricoBancario)) return false; return codigo != null && codigo.equals(((HistoricoBancario)o).codigo); }
}
