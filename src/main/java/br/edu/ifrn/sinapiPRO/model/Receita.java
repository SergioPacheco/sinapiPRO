...
public class Receita implements Serializable {
	...
	@OneToMany(mappedBy = "receita", cascade = CascadeType.ALL, orphanRemoval = true) private List<RecebimentoReceita> recebimentos = new ArrayList<>();
	...
	public List<RecebimentoReceita> getRecebimentos() { return recebimentos; }
	public boolean isNovo() { return codigo == null; }
	@Override public int hashCode() { return codigo == null ? 0 : codigo.hashCode(); }
	@Override public boolean equals(Object o) { if (!(o instanceof Receita)) return false; return codigo != null && codigo.equals(((Receita)o).codigo); }
}
