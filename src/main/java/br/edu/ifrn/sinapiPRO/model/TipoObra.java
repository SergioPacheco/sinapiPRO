...
public class TipoObra implements Serializable {
	...
	@Override public boolean equals(Object o) { if (!(o instanceof TipoObra)) return false; return codigo != null && codigo.equals(((TipoObra)o).codigo); }
}
