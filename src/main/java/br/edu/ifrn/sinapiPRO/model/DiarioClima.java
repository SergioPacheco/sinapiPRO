...
@Entity @Table(name = "diario_clima")
public class DiarioClima implements Serializable {
	...
	@Override public boolean equals(Object o) { if (!(o instanceof DiarioClima)) return false; return codigo != null && codigo.equals(((DiarioClima)o).codigo); }
}
