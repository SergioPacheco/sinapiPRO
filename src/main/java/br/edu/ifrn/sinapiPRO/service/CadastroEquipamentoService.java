...
import br.edu.ifrn.sinapiPRO.model.Equipamento; import br.edu.ifrn.sinapiPRO.repository.EquipamentosRepository;
import br.edu.ifrn.sinapiPRO.service.exception.*;
@Service public class CadastroEquipamentoService {
	@Autowired private EquipamentosRepository repository;
	@Transactional public Equipamento salvar(Equipamento e) { return repository.saveAndFlush(e); }
	...
	public Equipamento getOne(Long c) { return repository.getOne(c); }
}
