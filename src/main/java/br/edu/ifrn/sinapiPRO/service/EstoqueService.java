...
import br.edu.ifrn.sinapiPRO.model.Estoque; import br.edu.ifrn.sinapiPRO.model.MovimentoEstoque;
...
@Service public class EstoqueService {
	...
	@Transactional public Estoque salvar(Estoque e) { return repository.saveAndFlush(e); }
	@Transactional public Estoque movimentar(Long codigoEstoque, MovimentoEstoque movimento) {
	...
	@Transactional(readOnly = true) public List<Estoque> findByObra(Long codigoObra) { return repository.findByObraCodigo(codigoObra); }
	@Transactional(readOnly = true) public Estoque buscarComMovimentos(Long codigo) { return repository.findById(codigo).orElseThrow(() -> new RuntimeException("Estoque não encontrado")); }
}
