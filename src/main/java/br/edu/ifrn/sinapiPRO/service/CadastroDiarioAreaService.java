...
@Service
public class CadastroDiarioAreaService {
	@Autowired
	private DiarioAreasRepository repository;
	@Transactional
	public DiarioArea salvar(DiarioArea e) {
	...
	public List<DiarioArea> findAll() {
		return repository.findAll();
	}

	public DiarioArea getOne(Long c) {
