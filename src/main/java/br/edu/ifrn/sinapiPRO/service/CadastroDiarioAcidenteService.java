...
@Service
public class CadastroDiarioAcidenteService {
	@Autowired
	private DiarioAcidentesRepository repository;
	@Transactional
	public DiarioAcidente salvar(DiarioAcidente e) {
	...
	public List<DiarioAcidente> findAll() {
		return repository.findAll();
	}

	public DiarioAcidente getOne(Long c) {
