...
@Service
public class CadastroDivisaoInsumoService {
	@Autowired
	private DivisoesInsumoRepository repository;
	@Transactional
	public DivisaoInsumo salvar(DivisaoInsumo d) {
	...
	public List<DivisaoInsumo> findAll() {
		return repository.findAll();
	}

	public DivisaoInsumo getOne(Long c) {
