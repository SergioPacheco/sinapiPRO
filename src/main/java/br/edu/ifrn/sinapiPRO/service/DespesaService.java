...
public class DespesaService {
	...
	public void excluir(Long c) {
		try {
			...
			throw new ImpossivelExcluirEntidadeException("Impossível apagar a despesa.");
		}
	}
	...
	public Despesa buscarComPagamentos(Long codigo) {
		return repository.findById(codigo).orElseThrow(() -> new RuntimeException("Despesa não encontrada"));
	}
}
