...
import br.edu.ifrn.sinapiPRO.model.Funcao; import br.edu.ifrn.sinapiPRO.repository.FuncoesRepository;
import br.edu.ifrn.sinapiPRO.repository.filter.FuncaoFilter; import br.edu.ifrn.sinapiPRO.service.exception.*;
@Service public class CadastroFuncaoService {
	@Autowired private FuncoesRepository repository;
	@Transactional public Funcao salvar(Funcao e) {
	...
	@Transactional(readOnly = true) public Page<Funcao> filtrar(FuncaoFilter f, Pageable p) { return repository.filtrar(f, p); }
	public List<Funcao> findAll() { return repository.findAll(); }
	public Funcao getOne(Long c) { return repository.getOne(c); }
}
