...
public class CadastroSubDivisaoInsumoService {
	@Autowired
	private SubDivisoesInsumoRepository repository;
	@Transactional
	public SubDivisaoInsumo salvar(SubDivisaoInsumo s) {
	...
	public List<SubDivisaoInsumo> findAll() {
		return repository.findAll();
	}

	public SubDivisaoInsumo getOne(Long c) {
