...
import br.edu.ifrn.sinapiPRO.model.Departamento; import br.edu.ifrn.sinapiPRO.repository.DepartamentosRepository;
import br.edu.ifrn.sinapiPRO.repository.filter.DepartamentoFilter; import br.edu.ifrn.sinapiPRO.service.exception.*;
@Service public class CadastroDepartamentoService {
	@Autowired private DepartamentosRepository repository;
	@Transactional public Departamento salvar(Departamento e) {
	...
	@Transactional(readOnly = true) public Page<Departamento> filtrar(DepartamentoFilter f, Pageable p) { return repository.filtrar(f, p); }
	public List<Departamento> findAll() { return repository.findAll(); }
	public Departamento getOne(Long c) { return repository.getOne(c); }
}
