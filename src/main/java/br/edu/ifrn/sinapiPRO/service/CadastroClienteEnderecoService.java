...
public class CadastroClienteEnderecoService {
	@Autowired
	private ClientesEnderecoRepository repository;
	@Transactional
	public ClienteEndereco salvar(ClienteEndereco e) {
	...
	public List<ClienteEndereco> findByCliente(Long codigoCliente) {
		return repository.findByClienteCodigo(codigoCliente);
	}

	public ClienteEndereco getOne(Long c) {
