...
import br.edu.ifrn.sinapiPRO.model.Empresa; import br.edu.ifrn.sinapiPRO.repository.EmpresasRepository;
import br.edu.ifrn.sinapiPRO.repository.filter.EmpresaFilter; import br.edu.ifrn.sinapiPRO.service.exception.*;
@Service public class CadastroEmpresaService {
	@Autowired private EmpresasRepository repository;
	@Transactional public Empresa salvar(Empresa e) {
	...
	@Transactional(readOnly = true) public Page<Empresa> filtrar(EmpresaFilter f, Pageable p) { return repository.filtrar(f, p); }
	public List<Empresa> findAll() { return repository.findAll(); }
	public Empresa getOne(Long c) { return repository.getOne(c); }
}
